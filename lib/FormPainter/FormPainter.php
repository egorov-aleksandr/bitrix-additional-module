<?php
namespace AdditionalOptions\FormPainter;
...
class FormPainter
{
    ...
    {?>
        <?php require_once $_SERVER["DOCUMENT_ROOT"].'/local/modules/additional.options/lib/option_list.php';
                            ...
                            <table class="adm-detail-content-table edit-table">
                                <tbody>
                                    ...
                                    foreach ($optionList[$formType]['ITEMS'] as $option):?>
                                        ...
                                        <?php else:?>
                                        <?php $optionValue = Option::get("additional.options", $option['OPTION'],'', $siteId);?>
                                        <tr>
                                            <td valign="top" width="50%" class="adm-detail-content-cell-l"><?=$option['NAME']?></td>
