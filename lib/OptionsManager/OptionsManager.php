<?php
namespace AdditionalOptions\OptionsManager;
...
{
    public string $moduleId = 'additional.options';
    ...
    {
        require $_SERVER["DOCUMENT_ROOT"].'/local/modules/additional.options/lib/option_list.php';
